...
'("Graph analysis configuration" "distance-from" :node :distance-from :sequence :none :distance :distance "")
'("Graph analysis configuration" "adjacent-from" :edge :origin :sequence :none :adjacent :adjacent "")
'("Graph analysis configuration" "reachable-from" :node :reachable-from :sequence :none :reachable :reachable "")
'("Graph analysis configuration" "reachable-limit" :node :reachable-limit :sequence :none :reachable :reachable "")
'("Graphviz sequence classification" "node-fillcolor-by" :node :none :sequence :none :none :classification "")
...
'("Graphviz sequence edge font color schemes" "phases" :edge :colorscheme :sequence :edge-fontcolor-by :phases :phases "set2")
'("Graphviz sequence edge color schemes" "levels" :edge :colorscheme :sequence :edge-color-by :levels :levels "accent")
'("Graphviz sequence edge color schemes" "distance" :edge :colorscheme :sequence :edge-color-by :distance :distance "accent")
'("Graphviz sequence edge color schemes" "periods" :edge :colorscheme :sequence :edge-color-by :periods :periods "set1")
'("Graphviz sequence edge color schemes" "phases" :edge :colorscheme :sequence :edge-color-by :phases :phases "set2")
...
'("Graphviz sequence node fill color schemes" "phases" :node :colorscheme :sequence :node-fillcolor-by :phases :phases "set2")
'("Graphviz sequence node font color schemes" "levels" :node :colorscheme :sequence :node-fontcolor-by :levels :levels "accent")
'("Graphviz sequence node font color schemes" "distance" :node :colorscheme :sequence :node-fontcolor-by :distance :distance "accent")
'("Graphviz sequence node font color schemes" "periods" :node :colorscheme :sequence :node-fontcolor-by :periods :periods "set1")
'("Graphviz sequence node font color schemes" "phases" :node :colorscheme :sequence :node-fontcolor-by :phases :phases "set2")
'("Graphviz sequence node color schemes" "levels" :node :colorscheme :sequence :node-color-by :levels :levels "accent")
'("Graphviz sequence node color schemes" "distance" :node :colorscheme :sequence :node-color-by :distance :distance "accent")
'("Graphviz sequence node color schemes" "periods" :node :colorscheme :sequence :node-color-by :periods :periods "set1")
'("Graphviz sequence node color schemes" "phases" :node :colorscheme :sequence :node-color-by :phases :phases "set2")
'("Graphviz sequence reachability node colors" "origin" :node :origin :sequence :node-color-by :reachable :reachable "0")
'("Graphviz sequence reachability node colors" "reachable" :node :reachable :sequence :node-color-by :reachable :reachable "1")
'("Graphviz sequence reachability node colors" "not-reachable" :node :not-reachable :sequence :node-color-by :reachable :reachable "2")
'("Graphviz sequence reachability node colors" "colorscheme" :node :colorscheme :sequence :node-color-by :reachable :reachable "accent")
'("Graphviz sequence reachability node fillcolors" "origin" :node :origin :sequence :node-fillcolor-by :reachable :reachable "0")
'("Graphviz sequence reachability node fillcolors" "reachable" :node :reachable :sequence :node-fillcolor-by :reachable :reachable "1")
'("Graphviz sequence reachability node fillcolors" "not-reachable" :node :not-reachable :sequence :node-fillcolor-by :reachable :reachable "2")
'("Graphviz sequence reachability node fillcolors" "colorscheme" :node :colorscheme :sequence :node-fillcolor-by :reachable :reachable "accent")
'("Graphviz sequence reachability node fontcolors" "origin" :node :origin :sequence :node-fontcolor-by :reachable :reachable "0")
'("Graphviz sequence reachability node fontcolors" "reachable" :node :reachable :sequence :node-fontcolor-by :reachable :reachable "1")
'("Graphviz sequence reachability node fontcolors" "not-reachable" :node :not-reachable :sequence :node-fontcolor-by :reachable :reachable "2")
'("Graphviz sequence reachability node fontcolors" "colorscheme" :node :colorscheme :sequence :node-fontcolor-by :reachable :reachable "accent")
...
'("Graphviz sequence reachability edge colors" "origin" :edge :origin :sequence :edge-color-by :reachable :reachable "0")
'("Graphviz sequence reachability edge colors" "reachable" :edge :reachable :sequence :edge-color-by :reachable :reachable "1")
'("Graphviz sequence reachability edge colors" "not-reachable" :edge :not-reachable :sequence :edge-color-by :reachable :reachable "2")
'("Graphviz sequence reachability edge colors" "colorscheme" :edge :colorscheme :sequence :edge-color-by :reachable :reachable "accent")
...
'("Graphviz sequence reachability edge fontcolors" "origin" :edge :origin :sequence :edge-fontcolor-by :reachable :reachable "0")
'("Graphviz sequence reachability edge fontcolors" "reachable" :edge :reachable :sequence :edge-fontcolor-by :reachable :reachable "1")
'("Graphviz sequence reachability edge fontcolors" "not-reachable" :edge :not-reachable :sequence :edge-fontcolor-by :reachable :reachable "2")
'("Graphviz sequence reachability edge fontcolors" "colorscheme" :edge :colorscheme :sequence :edge-fontcolor-by :reachable :reachable "accent")
...
'("Graphviz sequence reachability edge arrowhead" "origin" :edge :origin :sequence :edge-arrowhead-by :reachable :reachable "none")
'("Graphviz sequence reachability edge arrowhead" "reachable" :edge :reachable :sequence :edge-arrowhead-by :reachable :reachable "normal")
'("Graphviz sequence reachability edge arrowhead" "not-reachable" :edge :not-reachable :sequence :edge-arrowhead-by :reachable :reachable "open")
'("Graphviz sequence adjacent node colors" "origin" :node :origin :sequence :node-color-by :adjacent :adjacent "0")
'("Graphviz sequence adjacent node colors" "adjacent" :node :adjacent :sequence :node-color-by :adjacent :adjacent "1")
'("Graphviz sequence adjacent node colors" "not-adjacent" :node :not-adjacent :sequence :node-color-by :adjacent :adjacent "2")
'("Graphviz sequence adjacent node colors" "colorscheme" :node :colorscheme :sequence :node-color-by :adjacent :adjacent "rdylbu")
'("Graphviz sequence adjacent node fillcolors" "origin" :node :origin :sequence :node-fillcolor-by :adjacent :adjacent "0")
'("Graphviz sequence adjacent node fillcolors" "adjacent" :node :adjacent :sequence :node-fillcolor-by :adjacent :adjacent "1")
'("Graphviz sequence adjacent node fillcolors" "not-adjacent" :node :not-adjacent :sequence :node-fillcolor-by :adjacent :adjacent "2")
'("Graphviz sequence adjacent node fillcolors" "colorscheme" :node :colorscheme :sequence :node-fillcolor-by :adjacent :adjacent "rdylbu")
'("Graphviz sequence adjacent node fontcolors" "origin" :node :origin :sequence :node-fontcolor-by :adjacent :adjacent "0")
'("Graphviz sequence adjacent node fontcolors" "adjacent" :node :adjacent :sequence :node-fontcolor-by :adjacent :adjacent "1")
'("Graphviz sequence adjacent node fontcolors" "not-adjacent" :node :not-adjacent :sequence :node-fontcolor-by :adjacent :adjacent "2")
'("Graphviz sequence adjacent node fontcolors" "colorscheme" :node :colorscheme :sequence :node-fontcolor-by :adjacent :adjacent "dark2")
...
'("Graphviz sequence adjacent edge colors" "origin" :edge :origin :sequence :edge-color-by :adjacent :adjacent "0")
'("Graphviz sequence adjacent edge colors" "adjacent" :edge :adjacent :sequence :edge-color-by :adjacent :adjacent "1")
'("Graphviz sequence adjacent edge colors" "not-adjacent" :edge :not-adjacent :sequence :edge-color-by :adjacent :adjacent "2")
'("Graphviz sequence adjacent edge colors" "colorscheme" :edge :colorscheme :sequence :edge-color-by :adjacent :adjacent "rdylbu")
...
'("Graphviz sequence adjacent edge fontcolor" "origin" :edge :origin :sequence :edge-fontcolor-by :adjacent :adjacent "0")
'("Graphviz sequence adjacent edge fontcolor" "adjacent" :edge :adjacent :sequence :edge-fontcolor-by :adjacent :adjacent "1")
'("Graphviz sequence adjacent edge fontcolor" "not-adjacent" :edge :not-adjacent :sequence :edge-fontcolor-by :adjacent :adjacent "2")
'("Graphviz sequence adjacent edge fontcolor" "colorscheme" :edge :colorscheme :sequence :edge-fontcolor-by :adjacent :adjacent "rdylbu")
...
'("Graphviz sequence adjacent edge arrowhead" "origin" :edge :origin :sequence :edge-arrowhead-by :adjacent :adjacent "none")
'("Graphviz sequence adjacent edge arrowhead" "adjacent" :edge :adjacent :sequence :edge-arrowhead-by :adjacent :adjacent "normal")
'("Graphviz sequence adjacent edge arrowhead" "not-adjacent" :edge :not-adjacent :sequence :edge-arrowhead-by :adjacent :adjacent "open")
...
'("Graphviz sequence unit node fillcolor" "deposit" :node :deposit :sequence :node-fillcolor-by :units :units "green")
'("Graphviz sequence unit node fillcolor" "interface" :node :interface :sequence :node-fillcolor-by :units :units "red")
'("Graphviz sequence unit node fillcolor" "colorscheme" :node :colorscheme :sequence :node-fillcolor-by :units :units "x11")
'("Graphviz sequence unit node fontcolor" "deposit" :node :deposit :sequence :node-fontcolor-by :units :units "green")
'("Graphviz sequence unit node fontcolor" "interface" :node :interface :sequence :node-fontcolor-by :units :units "red")
'("Graphviz sequence unit node fontcolor" "colorscheme" :node :colorscheme :sequence :node-fontcolor-by :units :units "x11")
...
'("Graphviz sequence unit edge arrowhead" "deposit" :edge :deposit :sequence :edge-arrowhead-by :units :units "none")
'("Graphviz sequence unit edge arrowhead" "interface" :edge :interface :sequence :edge-arrowhead-by :units :units "normal")
'("Graphviz sequence unit edge fontsize" "deposit" :edge :deposit :sequence :edge-fontsize-by :units :units "14.0")
'("Graphviz sequence unit edge fontsize" "interface" :edge :interface :sequence :edge-fontsize-by :units :units "10.0")
'("Graphviz chronology graph attributes" "colorscheme" :graph :colorscheme :chronology :none :none :none "x11")
'("Graphviz chronology graph attributes" "fontname" :graph :fontname :chronology :none :none :none "Time-Roman")
'("Graphviz chronology graph attributes" "fontsize" :graph :fontsize :chronology :none :none :none "14.0")
'("Graphviz chronology graph attributes" "fontcolor" :graph :fontcolor :chronology :none :none :none "black")
...
'("Graphviz chronology edge attributes" "sequential" :edge :sequential :chronology :none :none :none "solid")
