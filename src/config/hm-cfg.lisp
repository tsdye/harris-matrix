...
'("Graphviz sequence reachability node fillcolors" "origin" :node :origin :sequence :node-fillcolor-by :reachable :reachable "1")
'("Graphviz sequence reachability node fillcolors" "reachable" :node :reachable :sequence :node-fillcolor-by :reachable :reachable "2")
'("Graphviz sequence reachability node fillcolors" "not-reachable" :node :not-reachable :sequence :node-fillcolor-by :reachable :reachable "3")
'("Graphviz sequence reachability node fillcolors" "colorscheme" :node :colorscheme :sequence :node-fillcolor-by :reachable :reachable "accent3")
'("Graphviz sequence reachability node fontcolors" "origin" :node :origin :sequence :node-fontcolor-by :reachable :reachable "1")
'("Graphviz sequence reachability node fontcolors" "reachable" :node :reachable :sequence :node-fontcolor-by :reachable :reachable "2")
'("Graphviz sequence reachability node fontcolors" "not-reachable" :node :not-reachable :sequence :node-fontcolor-by :reachable :reachable "3")
'("Graphviz sequence reachability node fontcolors" "colorscheme" :node :colorscheme :sequence :node-fontcolor-by :reachable :reachable "accent3")
...
'("Graphviz sequence adjacent node fillcolors" "origin" :node :origin :sequence :node-fillcolor-by :adjacent :adjacent "1")
'("Graphviz sequence adjacent node fillcolors" "adjacent" :node :adjacent :sequence :node-fillcolor-by :adjacent :adjacent "2")
'("Graphviz sequence adjacent node fillcolors" "not-adjacent" :node :not-adjacent :sequence :node-fillcolor-by :adjacent :adjacent "3")
'("Graphviz sequence adjacent node fillcolors" "colorscheme" :node :colorscheme :sequence :node-fillcolor-by :adjacent :adjacent "rdylbu3")
...
(defun Graphviz-node-polygon-shape-problem? (cfg)
  ...
  (let ((polygon-shaper-p (or (sequence-classifier cfg :node-polygon-distortion-by)
        ...
        (empty-node-shape-by-p (not (sequence-classifier cfg :node-shape-by)))
        (polygon-shape-p (equal (get-option cfg "Graphviz sequence node attributes"
                                            "shape") "polygon")))
    (when polygon-shape-p
      (not (and empty-node-shape-by-p polygon-shaper-p)))))
