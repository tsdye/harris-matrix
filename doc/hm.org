...
[[file:../examples/fig-12-chronology/fig-12-sequence.png][file:../examples/fig-12-chronology/fig-12-sequence-small.png]]
...
stratigraphic DAG's are required. Figure [[fig-12-correlations]] shows the
...
[[file:../examples/fig-12-chronology/fig-12-correlations.png][file:../examples/fig-12-chronology/fig-12-correlations-small.png]]
...
[[file:../examples/bldg-1-5/bldg-1-5-sequence.png][file:../examples/bldg-1-5/bldg-1-5-sequence-small.png]]
...
[[file:../examples/bldg-1-5/bldg-1-5-chronology.png][file:../examples/bldg-1-5/bldg-1-5-chronology-small.png]]
* Classifiers
...
[[file:../examples/fig-12-chronology/fig-12-periods.png][file:../examples/fig-12-chronology/fig-12-periods-small.png]]
...
[[file:../examples/bldg-1-5/bldg-1-5-sequence-reachable-1332+.png][file:../examples/bldg-1-5/bldg-1-5-sequence-reachable-1332+-small.png]]
...
[[file:../examples/bldg-1-5/bldg-1-5-sequence-distance-1332+.png][file:../examples/bldg-1-5/bldg-1-5-sequence-distance-1332+-small.png]]
...
[[file:../examples/bldg-1-5/bldg-1-5-sequence-levels.png][file:../examples/bldg-1-5/bldg-1-5-sequence-levels-small.png]]
...
#+header: :exports code :eval never
#+BEGIN_SRC lisp
(defvar *seq*)
...
[[file:../examples/fig-12-chronology/fig-12-polygon-1.png][file:../examples/fig-12-chronology/fig-12-polygon-1-small.png]]
...
* DONE The Configuration File
 ...
 #+header: :results output :exports both :wrap example :eval never
 #+BEGIN_SRC lisp
   (use-package :hm)
...
#+BEGIN_SRC sh
head ~/quicklisp/local-projects/harris-matrix/examples/bldg-1-5/bldg-1-5-periods.csv
#+END_SRC
...
#+header: :exports results :results raw :wrap example
#+BEGIN_SRC sh
head ~/quicklisp/local-projects/harris-matrix/examples/bldg-1-5/bldg-1-5-dates.csv
#+END_SRC
...
#+BEGIN_SRC lisp
  ...
  (clod:document-package
   :hm "~/quicklisp/local-projects/harris-matrix/doc/hm-clod.org"
